...
- **Play** (`play.html`) — one game that adapts to the table size you pick on the home
  page (above the Play card): anywhere from heads-up (2) to six-handed cutthroat — deal,
  discard, cut, interactive pegging, the show, race to 121. The deal/crib rules adjust per
  player count (3-handed flips a deck card into the crib; at 5–6 the dealer, and at 6 the
  seat to their right, are dealt four and throw none).
