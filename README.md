...
- **Play** (`play.html`) — one consolidated game that adapts to the table size set in
  its settings: anywhere from heads-up (2) to six-handed cutthroat. Cut, discard, peg,
  the show, race to 121.
...
node engine/verify_play.js      # play.html reducer: consolidated page at P=2 through 6
